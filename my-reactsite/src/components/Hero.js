    ...
    return(
        <div className="text-white">
            <div className="font-bold mx-auto max-w-screen-lg flex flex-col h-screen w-full p-10 justify-center items-center">
                <img src="logo512.png" className="h-24 md:h-32 animate-bounce"/>
                ...
                <p className="md:max-w-full max-w-lg md:text-xl text-xs w-auto text-gray-600 mt-2 p-1 self-center text-center">It's widely used in both small projects and large-scale applications.</p>
