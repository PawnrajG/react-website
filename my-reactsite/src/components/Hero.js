...
const Hero = () =>{
    return(
        <div className="text-white">
            <div className="font-bold mx-auto max-w-screen-lg flex flex-col h-[600px] w-full p-10 justify-center items-center">
                <h2 className="uppercase md:text-2xl text-sm text-cyan-300 m-2 p-1">To learn about the react</h2>
                <h1 className="md:text-6xl text-2xl w-auto text-white m-2 p-1">Create Web in React.</h1>
