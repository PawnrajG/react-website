...
const Navbar = () =>{
    ...
    return(
        <div className="mx-auto max-w-screen-lg text-white flex flex-row w-full justify-between items-center p-4 bg-black">
            ...
            <ul className="hidden text-lg flex-row md:flex">
                ...
                <li className="mx-4 p-1 text-cyan-300 hover:text-cyan-100 cursor-pointer transform hover:scale-110 transition ease-in-out duration-300">Learn</li>
            ...
            <div className={!menu ? "md:hidden fixed w-72 top-0 left-0 h-full border-r border-r-gray-600 bg-[#000300] ease-in-out duration-500" : "hidden left-[-100%]"}>
                ...
                <ul className="my-20 uppercase">
                   ...
                   <li className="text-cyan-300 hover:text-cyan-100 m-5 py-3 px-10 border-y border-y-gray-900 cursor-pointer">Learn</li>
