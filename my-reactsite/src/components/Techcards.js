    ...
    return(
        <div className='w-full bg-white my-8'>
            ...
            <div className='max-w-screen-lg mx-auto grid grid-row-1 gap-0 md:grid-cols-3 p-4'>
                <div className='text-center h-auto w-auto md:w-72 text-black text-lg flex flex-col justify-around items-center shadow-xl border-2 p-3 m-3 md:ml-8 md:p-5 md:my-10 rounded-xl hover:scale-105 duration-300'>
                ...
                <div className='text-center h-auto w-auto md:w-72 text-black text-lg flex flex-col justify-around items-center shadow-xl border-2 p-3 m-3 md:ml-7 md:my-5 md:p-5 rounded-xl hover:scale-105 duration-300'>
                ...
                <div className='text-center h-auto w-auto md:w-72 text-black text-lg flex flex-col justify-around items-center shadow-xl border-2 p-3 m-3 md:ml-6 md:my-10 md:p-5 rounded-xl hover:scale-105 duration-300'>
