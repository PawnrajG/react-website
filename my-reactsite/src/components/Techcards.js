    ...
    return(
        <div className='w-full bg-white my-8'>
            ...
            <div className='max-w-screen-lg mx-auto grid grid-row-1 gap-0 md:grid-cols-3 p-4'>
                ...
                <div className='text-center h-auto w-full md:w-64 text-black text-lg flex flex-col justify-around items-center shadow-xl border-2 p-3 my-3 md:ml-6 md:my-5 md:p-3 rounded-xl hover:scale-105 duration-300'>
                ...
                <div className='text-center h-auto w-full md:w-64 text-black text-lg flex flex-col justify-around items-center shadow-xl border-2 p-3 my-3 md:mx-8 md:my-10 md:p-3 rounded-xl hover:scale-105 duration-300'>
