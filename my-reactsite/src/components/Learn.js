        ...
        <div className="w-full bg-slate-100">
            <div className="mx-auto max-w-screen-lg grid sm:grid-cols-2 justify-center items-center p-3">
                ...
                <div className="text-black font-bold m-5 flex flex-col">
                    ...
                    <a href="https://react.dev/learn" className="w-[150px] border-2 border-black text-black rounded-full px-5 py-2 m-4 hover:scale-110 transition ease-in-out duration-300">Start Learning</a>
                </div>
            </div>  
        </div>
    );
